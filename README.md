...
# 💫 About Me:
Hi there! I'm **Ashvin Manoj**, an **AI/ML Engineer** and **M.Tech Student** specializing in Deep Learning, NLP, and Computer Vision. I am passionate about building intelligent systems that perceive, understand, and interact with the world.<br><br>

👨‍💻 **Currently:** Working as a **Data Science Intern at Mastermine Technologies**, building cross-platform desktop apps (Java Spring, React, Electron) and LLM-based data insight frameworks.<br>
🎓 **Education:** M.Tech in Computer Science & Engineering (AI/ML) at Rajagiri School of Engineering | B.Tech (Honours) in Robotics & Automation.<br>
🧠 **Research Interests:** Multimodal Graph Learning (Alzheimer's Classification), Hybrid Transformer Models, and Generative AI.<br>
🤖 **Key Projects:**
